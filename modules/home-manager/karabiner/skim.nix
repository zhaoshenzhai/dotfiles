{
    ...
    manipulators = [
        ...
        { # ctrl+w -> close tab
            ...
            to = [
                ...
                { shell_command = "zsh -c 'skimUtils cleanDuplicates &'"; }
            ];
            conditions = [
                { type = "variable_unless"; name = "spotlight_mode"; value = 1; }
                { type = "variable_if"; name = "skim_search_mode"; value = 0; }
        ...
        { # ctrl+u -> reopen most recently closed tab
            ...
            to = [{ shell_command = "zsh -c 'skimUtils reopenLastClosed'"; }];
            conditions = [
                {
                    type = "frontmost_application_if";
                    bundle_identifiers = [ "^net\\.sourceforge\\.skim-app\\.skim$" ];
        ...
        { # s -> fit to width
            ...
            to = [
                ...
                { set_variable = { name = "skim_horizontal_mode"; value = 0; }; }
                { set_variable = { name = "skim_double_page_mode"; value = 0; }; }
            ];
            conditions = [
                { type = "variable_unless"; name = "spotlight_mode"; value = 1; }
                { type = "variable_if"; name = "skim_search_mode"; value = 0; }
                { type = "variable_if"; name = "skim_horizontal_mode"; value = 1; }
                {
                    type = "frontmost_application_if";
                    bundle_identifiers = [ "^net\\.sourceforge\\.skim-app\\.skim$" ];
                }
        ...
        }
        {
            ...
            conditions = [
                { type = "variable_unless"; name = "spotlight_mode"; value = 1; }
                { type = "variable_if"; name = "skim_search_mode"; value = 0; }
                { type = "variable_unless"; name = "skim_horizontal_mode"; value = 1; }
                {
                    type = "frontmost_application_if";
                    bundle_identifiers = [ "^net\\.sourceforge\\.skim-app\\.skim$" ];
                }
        ...
        { # a -> horizontal scroll & fit to height
            type = "basic";
            from = { key_code = "a"; };
            to = [
                { key_code = "3"; modifiers = [ "control" "option" "command" ]; }
                { key_code = "hyphen"; modifiers = [ "command" "shift" ]; }
                { set_variable = { name = "skim_horizontal_mode"; value = 1; }; }
                { set_variable = { name = "skim_double_page_mode"; value = 0; }; }
            ];
            conditions = [
                { type = "variable_unless"; name = "spotlight_mode"; value = 1; }
    ...
    ]    ++ (builtins.genList (i: { # ctrl+1 through ctrl+9 -> switch tabs
            type = "basic";
            from = { key_code = toString (i + 1); modifiers = { mandatory = [ "control" ]; }; };
            to = [ { shell_command = "zsh -c 'skimUtils switchTab ${toString (i + 1)}'"; } ];
            conditions = [
                { type = "variable_unless"; name = "spotlight_mode"; value = 1; }
                { type = "variable_if"; name = "skim_search_mode"; value = 0; }
                {
    ...
    ) 9) ++ (builtins.genList (i: { # ctrl+shift+1 through ctrl+shift+9 -> move tabs
            type = "basic";
            from = { key_code = toString (i + 1); modifiers = { mandatory = [ "control" "shift" ]; }; };
            to = [ { shell_command = "zsh -c 'skimUtils moveTab ${toString (i + 1)}'"; } ];
            conditions = [
                { type = "variable_unless"; name = "spotlight_mode"; value = 1; }
                { type = "variable_if"; name = "skim_search_mode"; value = 0; }
                {
