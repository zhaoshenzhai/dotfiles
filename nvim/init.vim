...
autocmd filetype vimwiki nnoremap <F6> :w <CR>:!~/.config/scripts/MathWiki/newTikZ.sh<CR>i<center><img src="https://raw.githubusercontent.com/zhaoshenzhai/MathWiki/master/Images/<C-r>=system('date +%d-%m-%Y_%H%M')<CR>/image.svg"></center><esc>I<backspace><esc>o<esc>o![[../Images/<C-r>=system('date +%d-%m-%Y_%H%M')<CR>/image.svg]]<esc>I<backspace><esc>
